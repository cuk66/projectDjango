...
class Relevance(ImageUpload, models.Model):
    graph_salary_level = models.ImageField(upload_to='image/', blank=False,
                                           verbose_name='График уровень зарплат по годам')
    graph_num_vacancy = models.ImageField(upload_to='image/', blank=False,
...
class Geography(models.Model):
    graph_salary_level_by_city = models.ImageField(upload_to='image/', blank=False,
                                                   verbose_name='График уровень зарплат по городам')
    graph_vacancy_fraction_by_city = models.ImageField(upload_to='image/', blank=False,
